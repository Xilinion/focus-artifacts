        ...
        '/dev/sda4': {
            120: {
                'tpcc-wh4': {
                    ...
                    'occ-serial': 2200,
                    'sto-memory': 4000,
                    'sto-counter-lazy': 4000,
                    'sto-sketch': 4000,
                    'sto-disk': 6000,
                    'sto-disk-cache': 5300,
                    'tictoc-memory': 5500,
                    'tictoc-counter-lazy': 5500,
                    'tictoc-sketch': 5500,
                    'tictoc-disk': 6500,
                    'tictoc-disk-cache': 5300,
                    'mvcc-memory': 4000,
                    'mvcc-couter-lazy': 4000,
                    'mvcc-sketch': 4000,
                    'mvcc-disk': 70000,
                    'mvcc-disk-cache': 5000,
                },
                'tpcc-wh8': {
                    ...
                    'occ-serial': 2100,
                    'sto-memory': 6500,
                    'sto-counter-lazy': 6500,
                    'sto-sketch': 6500,
                    'sto-disk': 7000,
                    'sto-disk-cache': 6500,
                    'tictoc-memory': 7500,
                    'tictoc-counter-lazy': 7500,
                    'tictoc-sketch': 7500,
                    'tictoc-disk': 8500,
                    'tictoc-disk-cache': 7500,
                    'mvcc-memory': 6000,
                    'mvcc-couter-lazy': 6000,
                    'mvcc-sketch': 6000,
                    'mvcc-disk': 140000,
